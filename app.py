...
train_generator = train_datagen.flow_from_directory(train_dir, target_size=(48, 48), batch_size=64, class_mode='categorical')
validation_generator = validation_datagen.flow_from_directory(validation_dir, target_size=(48, 48), batch_size=64, class_mode='categorical')
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        print("Emoção:", ["Angry", "Disgust", "Fear", "Happy", "Sad", "Surprise", "Neutral"][emotion])
